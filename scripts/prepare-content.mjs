...
<!-- smooth-scroll:end -->\n</body>`);
 ...
 html=html.replace(/(assets\/(?:js|css)\/[\w-]+\.(?:js|css))\?v=[^"']+/g,(match,asset)=>asset.includes('smooth-scroll')?match:asset+'?v='+(asset.endsWith('client-2026.css')?'20260922-type':'20260922-client'));

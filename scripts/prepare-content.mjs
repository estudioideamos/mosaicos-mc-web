...
<!-- smooth-scroll:end -->\n</body>`);
 ...
 html=html.replace(/(assets\/(?:js|css)\/[\w-]+\.(?:js|css))\?v=[^"']+/g,(match,asset)=>asset.includes('smooth-scroll')?match:asset+'?v='+(/(?:client-2026.css|client-catalog.js|products-pages.js)$/.test(asset)?'20260922-photo-scale':'20260922-client'));

...
<!-- smooth-scroll:end -->\n</body>`);
 ...
 html=html.replace(/(assets\/(?:js|css)\/[\w-]+\.(?:js|css))\?v=[^"']+/g,(match,asset)=>asset.includes('smooth-scroll')?match:/(?:client-2026|home-cinema)\.css$/.test(asset)?asset+'?v=20260924-cover':asset+'?v='+(/(?:client-2026.css|client-catalog.js|products-pages.js|quote-materials.js|factory-film.js)$/.test(asset)?'20260924-additions':'20260922-client'));
